...
<?php the_post(); ?>			
				...
				<h1 class="page-title author"><?php printf( __( 'About <span class="vcard">%s</span>', 'omgubuntu' ), "<a class='url fn n' href='$authordata->user_url' title='$authordata->display_name' rel='me'>$authordata->display_name</a>" ) ?></h1>
