...
<?php if ( have_posts() ) : ?>
				...
				<h1 class="page-title"><?php _e( 'Search Results for: ', 'omgubuntu' ); ?><span><?php the_search_query(); ?></span></h1>
...
<?php else : ?>
				...
				<div id="post-0" class="post no-results not-found">
					<h2 class="entry-title"><?php _e( 'Nothing Found', 'omgubuntu' ) ?></h2>
					<div class="entry-content">
						<p><?php _e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'omgubuntu' ); ?></p>
	<?php get_search_form(); ?>						
					</div><!-- .entry-content -->
				</div>
